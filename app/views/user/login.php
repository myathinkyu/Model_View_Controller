    ...
    <div class="container my-5">
        <div class="col-md-8 offset-md-2">
            <div class="card bg-light p-5">
                ...
                <h3 class="english text-info text-center mb-3 text-dark">Login To Post</h3>
                <form action="<?php echo URLROOT . 'user/login' ?>" method="post" autocomplete="on">
                    ...
                    <div class="row justify-content-between no-gutters">
                        <a href="<?php echo URLROOT. 'user/register' ?>" class="english text-dark">Not a user yet, Please Register!</a>
                        <div>
                            <button class="btn btn-outline-secondary english">Cancle</button>
                            <button class="btn btn-primary english bg-dark text-white border-0">Login</button>
                        </div>
                    </div>
                </form>
                <!-- register form end -->
